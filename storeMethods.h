...
public :
    ...
    string** select(const string &sub_name, const string &disp, const string &order="store.id");
    string** select_for_prov(const string &username, const string &order="store.id");
