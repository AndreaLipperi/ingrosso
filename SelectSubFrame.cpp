...
const long SelectSubFrame::IdButtonInsert =::wxNewId();
const long SelectSubFrame::IdButtonComeBack =::wxNewId();

BEGIN_EVENT_TABLE (SelectSubFrame, wxFrame)

                EVT_BUTTON(IdButtonInsert, SelectSubFrame::InsertProduct)
                EVT_BUTTON(IdButtonComeBack, SelectSubFrame::ComeBack)

END_EVENT_TABLE()

SelectSubFrame::SelectSubFrame( const wxString &title) :
...
void SelectSubFrame::ComeBack(wxCommandEvent &event) {
